...
logger = logging.getLogger("ddPrimer.direct")


def LocationFinder(sequence, ref_fasta, min_identity=90, min_coverage=90):
    """
...
def EmptyWarning(df, masked_sequences, matching_status=None):
    """
